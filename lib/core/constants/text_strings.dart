...
const String tAcceptPrivacy = "Accetto i termini sulla privacy *";
const String tAcceptConditions = "Accetto i termini e le condizioni *";
const String tAcceptReceiveUpdating = "Accetto di ricevere aggiornamenti via E-Mail";
...
const String tAddLowercase = "Aggiungi lettere minuscole";
const String tAddUppercase = "Aggiungi lettere maiuscole";
const String tAddNumber = "Aggiungi numeri";
